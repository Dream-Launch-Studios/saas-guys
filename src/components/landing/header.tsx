      ...
      <div className="container flex h-16 items-center justify-between mx-auto max-w-[1280px]">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6 ml-10">
            <Link href="#features" className="text-sm transition-colors hover:text-blue-600">
              Features
            </Link>
            <Link href="#how-it-works" className="text-sm transition-colors hover:text-blue-600">
              How It Works
            </Link>
            <Link href="#pricing" className="text-sm transition-colors hover:text-blue-600">
              Pricing
            </Link>
            <Link href="#" className="text-sm transition-colors hover:text-blue-600">
              Documentation
            </Link>
          </nav>
        </div>
