...
export default function Waitlist() {
  ...
  return (
    <motion.section
      ...
      className="bg-black py-20 mx-10 sm:mx-0 mt-4 md:mt-20"
    >
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="mt-8">
            <input
              ...
              required
              className="w-full p-2.5 rounded-md border border-rose-gold-300 bg-black text-white focus:outline-none focus:ring-2 focus:ring-rose-gold-500 transition duration-200"
            />
            {/* <button
              type="submit"
            ...
            <div className="mt-4 w-full flex justify-center sm:px-0">
              <button className="relative w-full inline-flex h-10 sm:h-12 overflow-hidden rounded-md p-[1px] focus:outline-none focus:ring-2 focus:ring-rose-gold-400 focus:ring-offset-2 focus:ring-offset-black">
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-black px-6 sm:px-10 py-2 sm:py-4 text-base sm:text-lg font-bold text-rose-gold-200 backdrop-blur-3xl hover:text-rose-gold-100 transition-colors duration-300">
                  Join Waitlist
                </span>
              </button>
            </div>
